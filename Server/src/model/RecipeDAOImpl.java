...
public class RecipeDAOImpl implements RecipeDAO
{
      ...
      throws SQLException
  {
    try (Connection connection = getConnection())
    {
      ...
      String sql =
          "Select distinct r.name, r.description, r.category, r.id, r.instructions, r.preperation_time, r.owner_id from recipes r inner join recipe_ingredien_connection c on r.id = c.recipeid \n"
